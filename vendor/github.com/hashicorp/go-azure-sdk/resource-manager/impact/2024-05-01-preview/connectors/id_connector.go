...
func NewConnectorID(subscriptionId string, connectorName string) ConnectorId {
	return ConnectorId{
...
func (id ConnectorId) ID() string {
	fmtString := "/subscriptions/%s/providers/Microsoft.Impact/connectors/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ConnectorName)
}
